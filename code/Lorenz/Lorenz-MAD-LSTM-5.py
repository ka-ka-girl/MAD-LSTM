...
e = tf.keras.layers.LSTM(32, return_sequences=True)(inputs)
...
e1 = tf.keras.layers.LSTM(32, return_sequences=True)(e)
...
#存储模型，方便使用
model.save('MAD-LSTM-5-32-300_2.h5')
