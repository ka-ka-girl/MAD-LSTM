...
e = tf.keras.layers.LSTM(48, return_sequences=True)(inputs)
...
c1 = tf.keras.layers.LSTM(48, return_sequences=True)(c)
d1 = tf.keras.layers.LSTM(48, return_sequences=True)(d)
e1 = tf.keras.layers.LSTM(48, return_sequences=True)(e)


x1 = a1*0.8 + b1*0.05 + c1*0.05 + d1*0.05 + e1*0.05
x2 = a1*0.05 + b1*0.85 + c1*0.025 + d1*0.025 + e1*0.05
x3 = a1*0.025 + b1*0.025 + c1*0.85 + d1*0.05 + e1*0.05
x4 = a1*0.05 + b1*0.1 + c1*0.05 + d1*0.7 + e1*0.1
x5 = a1*0.04 + b1*0.11 + c1*0.05 + d1*0.05 + e1*0.75


a2 = tf.keras.layers.LSTM(48)(x1)
b2 = tf.keras.layers.LSTM(48)(x2)
c2 = tf.keras.layers.LSTM(48)(x3)
d2 = tf.keras.layers.LSTM(48)(x4)
e2 = tf.keras.layers.LSTM(48)(x5)
